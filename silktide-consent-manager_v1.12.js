...
class SilktideCookieBanner {
  ...
  getModalContent() {
    ...
    const saveOptionsButton = `<button class="preferences-save-options st-button st-button--secondary"${
      saveOptionsButtonLabel && saveOptionsButtonLabel !== saveOptionsButtonText 
        ? ` aria-label="${saveOptionsButtonLabel}"` 
        : ''
  ...
  setupEventListeners() {
    ...
    if (this.modal) {
      ...
      const saveOptions = this.modal.querySelector('.preferences-save-options');
    ...
    const changeCookieOptionsButton = document.querySelector('[data-change-cookie-setting]');
    if (changeCookieOptionsButton) {
      changeCookieOptionsButton.addEventListener('click', () => {
